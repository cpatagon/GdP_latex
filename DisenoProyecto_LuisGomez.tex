...
\fechaFINALTrabajo{22 de mayo de 2024}	%Fecha de defensa pública del trabajo final
...
\input{01_descripcion.tex}

\section{2. Identificación y análisis de los interesados}
\label{sec:interesados}
\input{02_identificacion.tex}

\section{3. Propósito del proyecto}
\label{sec:proposito}
\input{03_proposito.tex}

\section{4. Alcance del proyecto}
\label{sec:alcance}
\input{04_alcance.tex}

\section{5. Supuestos del proyecto}
\label{sec:supuestos}
\input{05_supuestos.tex}

\section{6. Requerimientos}
\label{sec:requerimientos}
\input{06_requerimientos.tex}

\section{7. Historias de usuarios (\textit{Product backlog})}
\label{sec:backlog}
\input{07_historias.tex}

\section{8. Entregables principales del proyecto}
\label{sec:entregables}
\input{08_entregables.tex}
...
\input{12_Presupuesto.tex}


\section{13. Gestión de riesgos}
\label{sec:riesgos}
\input{13_riesgos.tex}

\section{14. Gestión de la calidad}
\label{sec:calidad}
\input{14_calidad.tex}
